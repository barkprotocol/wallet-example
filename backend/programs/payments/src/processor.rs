...
pub fn process_cancel_campaign(ctx: Context<CancelCampaign>) -> Result<()> {
    let campaign = &mut ctx.accounts.campaign;
...
pub fn process_donate(ctx: Context<Donate>, amount: u64) -> Result<()> {
    let campaign = &mut ctx.accounts.campaign;
...
pub fn process_cancel_donation(ctx: Context<CancelDonation>) -> Result<()> {
    let campaign = &mut ctx.accounts.campaign;
    let contribution = &mut ctx.accounts.contribution;
...
pub fn process_claim_donations(ctx: Context<ClaimDonations>) -> Result<()> {
    let campaign = &mut ctx.accounts.campaign;
...
pub fn process_update_campaign_metadata(
...
pub fn process_refund_donations(ctx: Context<RefundDonations>) -> Result<()> {
    let campaign = &mut ctx.accounts.campaign;
    let contribution = &mut ctx.accounts.contribution;
...
pub fn process_extend_campaign(ctx: Context<ExtendCampaign>, new_end_at: i64) -> Result<()> {
    let campaign = &mut ctx.accounts.campaign;
    ...
    msg!("Campaign '{}' extended to {}", campaign.key(), new_end_at);

    Ok(())
}

pub fn process_close_campaign(ctx: Context<CloseCampaign>) -> Result<()> {
    let campaign = &mut ctx.accounts.campaign;
